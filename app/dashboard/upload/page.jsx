...
function page() {
  ...
  return (
    <div className='h-full w-full flex justify-center p-2 py-8 lg:px-24'>
      ...
      <div className={`flex max-w-6xl  h-60 justify-center items-center py-24  w-full border-1 border-dashed rounded-sm border-blue-500 ${isFocused ||isDragAccept ? "bg-blue-300":"bg-slate-200"} }`}>
